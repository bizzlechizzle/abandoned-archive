...
- NGS: No Google Services (no Google Maps, Google APIs, Google Analytics, Google Fonts CDN, etc. Use open-source alternatives: Leaflet/OSM for maps, Nominatim for geocoding, self-hosted fonts)
